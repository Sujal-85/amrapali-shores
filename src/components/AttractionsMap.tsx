...
const attractions = [
  { id: 1, name: "भारतरत्न पां.वा.काणे स्मारक", icon: Landmark, distance: "2 km", type: "heritage", color: "#D97706", mapUrl: "https://maps.google.com/?q=Govind+Kane+Smarak+Dapoli" },
